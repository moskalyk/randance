...
class WalletRequestHandler {
  ...
  constructor(_signer, prompter, auxDataProvider, mainnetNetworks, testnetNetworks = []) {
    var _this = this;
    this.signer = void 0;
    this.signerReadyCallbacks = [];
    this.prompter = void 0;
    this.auxDataProvider = void 0;
  ...
  async connect(options) {
    ...
    if (options && options.askForEmail) {
      var _this$auxDataProvider;
      const email = await ((_this$auxDataProvider = this.auxDataProvider) == null ? void 0 : _this$auxDataProvider.get('email'));
      if (email) {
